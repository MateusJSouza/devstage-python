...
from src.model.repositories.interfaces.eventos_link_repository import EventosRepositoryInterface
...
class EventsLinkCreator():
  ...
  def __check_event_link(self, subscriber_id: int, event_id: int) -> None:
